...
})(this, function(__WEBPACK_EXTERNAL_MODULE_114__, __WEBPACK_EXTERNAL_MODULE_124__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SortableElement2 = __webpack_require__(271);

	var _SortableElement3 = _interopRequireDefault(_SortableElement2);

	var _SortableHandle2 = __webpack_require__(272);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.cloneNodeComputedStyles = cloneNodeComputedStyles;
	...
	function cloneNodeComputedStyles(source, target) {
	  if (typeof window === 'undefined' || typeof document === 'undefined') return; // server environment

	  var styles = window.getComputedStyle(source);

	  [].concat((0, _toConsumableArray3.default)(styles)).forEach(function (property) {
	    return target.style[property] = styles.getPropertyValue(property);
	  });

	  [].concat((0, _toConsumableArray3.default)(source.children)).forEach(function (child, index) {
	    return cloneNodeComputedStyles(child, target.children[index]);
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function sortableContainer(WrappedComponent) {
	  ...
	  return _temp = _class = function (_Component) {
	      ...
	      _this.handlePress = function (e) {
	        ...
	        if (active) {
	          var _this$props3 = _this.props,
	              ...
	              cloneComputedStyles = _this$props3.cloneComputedStyles;
	          ...
	          if (cloneComputedStyles) {
	            (0, _utils.cloneNodeComputedStyles)(node, clonedNode);
	          }
	    ...
	    cloneComputedStyles: _propTypes2.default.bool,
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function (test, buggy, set) {
	      try {
	        set = __webpack_require__(15)(Function.call, __webpack_require__(102).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _find = __webpack_require__(127);

	var _find2 = _interopRequireDefault(_find);

	var _sortBy = __webpack_require__(249);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseFlatten = __webpack_require__(250),
	    ...
	    baseRest = __webpack_require__(262),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseEach = __webpack_require__(254),
	    isArrayLike = __webpack_require__(215);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseForOwn = __webpack_require__(255),
